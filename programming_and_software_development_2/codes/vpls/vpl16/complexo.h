...
class Complexo {
 ...
 private:
  // A implementação atual utiliza representação polar/trigonométrica
  double _real;  // Módulo do vetor que representa o número.
  double _imag;  // Argumento do vetor (em radianos) que representa o número.
};
