...
class BinaryTree {
    public:
         ...
         */
        BinaryTree(std::string expression, int id);
        ...
        std::string posOrderA(NodeType *p);
 ...
 */
std::string change_letter_by_num(std::string s, char num, int id);
 ...
 */
std::string resume_string(std::string s1, std::string s2, int id);
