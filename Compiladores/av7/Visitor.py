...
class CtrGenVisitor(Visitor):
    ...
    def visit_eql(self, exp, type_var):
        ...
        """
        tv_operands = self.fresh_type_var()
        c1 = exp.left.accept(self, tv_operands)
        c2 = exp.right.accept(self, tv_operands)
        c3 = {(type(True), type_var)}
        return c1 | c2 | c3
    ...
    def visit_and(self, exp, type_var):
        ...
        solve them.
        """
        c1 = exp.left.accept(self, type(True))
        c2 = exp.right.accept(self, type(True))
        c3 = {(type(True), type_var)}
        return c1 | c2 | c3
    ...
    def visit_add(self, exp, type_var):
        ...
        """
        c1 = exp.left.accept(self, type(1))
        c2 = exp.right.accept(self, type(1))
        c3 = {(type(1), type_var)}
        return c1 | c2 | c3
    ...
    def visit_not(self, exp, type_var):
        ...
        Example:
            ...
            ["(<class 'bool'>, 'TV_1')", "(<class 'bool'>, <class 'bool'>)"]
        """
        c1 = exp.exp.accept(self, type(True))
        c2 = {(type(True), type_var)}
        return c1 | c2
    ...
    def visit_let(self, exp, type_var):
        ...
        """
        c1 = exp.exp_def.accept(self, exp.identifier)
        c2 = exp.exp_body.accept(self, type_var)
        return c1 | c2
    ...
    def visit_ifThenElse(self, exp, type_var):
        ...
        """
        c1 = exp.cond.accept(self, type(True))
        c2 = exp.e0.accept(self, type_var)
        c3 = exp.e1.accept(self, type_var)
        return c1 | c2 | c3
