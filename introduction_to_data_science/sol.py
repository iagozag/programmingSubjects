...
def high_delay(df):
    ...
    good = good[['OriginAirportName', 'DestAirportName', 'Q5']].sort_values('Q5', ascending=False).iloc[0]
    return (good['OriginAirportName'], good['DestAirportName'])
...
df.boxplot(column='DepDelay', by='DayOfWeek', grid=False, showfliers=False, figsize=(10, 6))
...
plt.scatter(good.DepDelay, good.ArrDelay, edgecolor='k', alpha=0.75)
plt.xlabel('DepDelay')
plt.ylabel('ArrDelay')